/**
 * @fileoverview Alert Event History & Delivery Audit Mongoose Schema
 * @module db/models/alertEvent.model
 * @description
 * Section 99.7 (`alert_events` collection):
 * Records every proactive maritime warning generated by the background worker scheduler.
 *
 * Operational & Audit Features:
 * - Evidence Tracing: Links directly back to `analysis_id` so notifications are backed
 *   by verifiable raw weather and ocean measurements.
 * - Deduplication Auditing: Records both dispatched and suppressed notifications,
 *   proving whether an alert was actively throttled by the deduplication window.
 */
